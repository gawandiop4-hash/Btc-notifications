...
const CHART_API = 'https://api.binance.com/api/v3/klines?symbol=BTCUSDT&interval=1h&limit=800';
...
function showTestNotification() {
  if (Notification.permission === 'granted') {
    var notification = new Notification('Sistema Notifiche Attivo', {
...
function showRSIAlert(level) {
  ...
  if ('Notification' in window && Notification.permission === 'granted') {
    try {
      ...
      currentNotification.onshow = function() {
